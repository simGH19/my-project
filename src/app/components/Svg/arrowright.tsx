...
export default function Arrowright() {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox="0 0 24 24"><title>arrow_right_up_line</title><g id="arrow_right_up_line" fill='none' fillRule='nonzero'>
      ...
      <path fill='#D3E97A' d='M18 5a1 1 0 0 1 1 1v8a1 1 0 1 1-2 0V8.414l-9.95 9.95a1 1 0 0 1-1.414-1.414L15.586 7H10a1 1 0 1 1 0-2h8Z'/></g></svg>
  )
}
